    ...
    const _drawGrid = () => {
        ...
        for (let coord in barGrid) {
            ...
            switch (barGrid[coord].type) {
                      ...
                      showInToolTip
                        ...
                        let toolTip = <>
                            <div key={`tooltip-${barGrid[coord].key}`}>
                                ...
                                <div>
                                    Chair.   <br />
                                    key: {thisChair.key} <br />
                                    chairId: {thisChair.id} <br />
                                    tableId:   {thisChair.tableId} <br />
                                </div>

                                <div style={{ display: "flex", flexDirection: "column" }}>
                                    <span>
                                        x distance: {thisChair.x}
                                    </span>
                                    <span>
                                        y distance: {thisChair.y}
                                    </span>
                                    <span>
                                        x coord: {thisChair.xCoord}
                                    </span>
                                    <span>
                                        y coord: {thisChair.yCoord}
                                    </span>
                                    <span>
                ...
                case "table":
                    let table = barGrid[coord] as Table;
                    let toolTip = <>
